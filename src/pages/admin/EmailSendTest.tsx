...
const AdminEmailSendTest: React.FC = () => {
  ...
  const [availableEnvironments, setAvailableEnvironments] = useState<TransferItem[]>([
    { id: '1', label: 'Ambiente 1', value: 'env1' },
    { id: '2', label: 'Ambiente 2', value: 'env2' },
    { id: '3', label: 'Ambiente 3', value: 'env3' }
  ]);
  ...
  const handleSendEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccess(`Email enviado com sucesso para ${selectedEnvironments.length} ambiente(s)`);
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Enviar Email - Teste</h1>
                <p className="text-gray-600">Teste do componente TransferList</p>
              </div>
            </div>
          </div>
        </div>
...
export default AdminEmailSendTest;
